...
enum class Material(
    ...
    ENEMY_TANK_RESPAWN(false, false, true, 3, CELLS_TANK_SIZE, CELLS_TANK_SIZE, R.drawable.enemy_tank),
    PLAYER_TANK_RESPAWN(false, false, true, 1, CELLS_TANK_SIZE, CELLS_TANK_SIZE, R.drawable.tank)
}